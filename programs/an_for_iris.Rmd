...
df <- df %>%
  ...
  mutate(rmil2 = s_mil*rbea_nat,
         ...
         Fhx2_spill = (1/8)*(Fhx2_nat - Fhx2),
         Fhx2_nat50 = (1/9)*Fhx2_nat,
...
bmark_scatterplot <- ggplot(hall, aes(x=Fhx2_spill, y= resid)) +
...
bmark_scatterplot
ggsave("../output/scatterplot_dots.pdf", bmark_scatterplot, device = "pdf", height = 5, width = 9)
