...
use "../data/GIS partition ver2.dta", clear
postal_to_FIPS state_abbr
rename statefips fips
save ../data/GIS_partition_ver2_tmp.dta, replace
...
fips_to_census fips
merge m:1 fips using ../data/GIS_partition_ver2_tmp
...
**** Save dataset
save ../data/cleaned_gis6_panel_gdp.dta, replace
