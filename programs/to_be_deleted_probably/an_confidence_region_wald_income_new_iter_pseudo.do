...
PartialGMM2S,  t(`T') i(`N') dep(y) indep(x) instrument(z) yy(`Y0') partition(part) maxiter(50)
mat phi    = e(phi)
mat phi_2s = e(phi)
mat phi_v  = e(Sigma)
mat y_aux  = y - x*phi

PartialGMM2S,  t(`T') i(`N') dep(y_aux) indep(z) instrument(z) yy(`Y0') partition(part) maxiter(50)
...
if "`do_print'" == "Y"{	   
graph export ../output/ci_blob_95_iv_`mm'_income_new_iter.pdf,  replace
}	   
